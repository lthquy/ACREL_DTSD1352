...
// Theo manual: 05DDH - 05E2H, 32-bit registers
#define REG_THD_VOLTAGE_A               0x05DD
#define REG_THD_VOLTAGE_B               0x05DE
#define REG_THD_VOLTAGE_C               0x05DF
#define REG_THD_CURRENT_A               0x05E0
#define REG_THD_CURRENT_B               0x05E1
#define REG_THD_CURRENT_C               0x05E2

// Harmonic Registers - 5th Order (Bậc 5)
// Thường ở địa chỉ tiếp theo sau THD
#define REG_HARMONIC5_VOLTAGE_A         0x05ED
#define REG_HARMONIC5_VOLTAGE_B         0x060B
#define REG_HARMONIC5_VOLTAGE_C         0x0629
#define REG_HARMONIC5_CURRENT_A         0x0647
#define REG_HARMONIC5_CURRENT_B         0x0665
#define REG_HARMONIC5_CURRENT_C         0x0683

// Harmonic Registers - 7th Order (Bậc 7)
#define REG_HARMONIC7_VOLTAGE_A         0x030C
#define REG_HARMONIC7_VOLTAGE_B         0x030E
#define REG_HARMONIC7_VOLTAGE_C         0x0310
#define REG_HARMONIC7_CURRENT_A         0x0312
#define REG_HARMONIC7_CURRENT_B         0x0314
#define REG_HARMONIC7_CURRENT_C         0x0316
...
class ACREL_DTSD1352 {
  public:
    ...
    // Harmonic N-th Order (Bậc N) - DYNAMIC
    // Đọc harmonic bất kỳ với tham số n
    struct HarmonicNData {
      uint8_t order;  // Bậc harmonic (3, 5, 7, 9, 11, ...)
      float voltageA, voltageB, voltageC;
      float currentA, currentB, currentC;
      bool valid;
    };
    HarmonicNData readHarmonicN(uint8_t n);
